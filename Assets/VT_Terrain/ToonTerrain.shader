Shader "ToonTerrain"
{
    Properties
    {
        ...
        _HeightTransition("Height Transition", Range(0.001, 1.0)) = 0.0
...
//		
        ...
        _ShadowMapColor("Shadow Color", Color) = (0.5,0.5,0.5)

        [HideInInspector] _TerrainHolesTexture("Holes Map (RGB)", 2D) = "white" {}

        [Toggle(_TERRAIN_BLEND_HEIGHT)] _EnableHeight("_EnableHeight", Float) = 1.0
    }
