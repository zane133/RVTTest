...
#endif
{
    ...
    float4 indexData = SAMPLE_TEXTURE2D(_VT_IndexTex, sampler_VT_IndexTex, (IN.tc_Control));
    ...
    albedo = SAMPLE_TEXTURE2D_ARRAY_LOD(_VT_AlbedoTex, sampler_VT_AlbedoTex,
                                        localUV, indexData.r, mipmap);
    normalTS = SAMPLE_TEXTURE2D_ARRAY_LOD(_VT_NormalTex, sampler_VT_NormalTex,
                                          localUV, indexData.r, mipmap);
    ...
    // half4 color = half4( ToonLighting(IN.positionWS, IN.normal, albedo), 1);
